...
insert into usuario values ("123", "Pepe" , "pepe@email.com", "13434", "pepe", 1);
insert into usuario values ("124", "Maria" , "maria@email.com", "43433", "maria", 2);
insert into usuario values ("125", "Juan" , "juan@email.com", "3333", "juan", 1);
...
insert into compra values (1, "2021/10/05 20:12:05", "PSE", "125");
insert into compra values (2, "2021/10/05 12:10:09", "tarjeta crédito VISA", "123");

insert into detalle_compra values(1, 2_000_000, 1, 1, 2);
insert into detalle_compra values(2, 225_000, 1, 1, 3);
insert into detalle_compra values(3, 4_000_000, 1, 2, 1);
