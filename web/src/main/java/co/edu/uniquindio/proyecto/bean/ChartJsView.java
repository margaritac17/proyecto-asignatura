...
public class ChartJsView implements Serializable {
    ...
    public void createBarModel() {
        ...
        barDataSet.setLabel("Calificacion Promedio");

        List<Number> values = new ArrayList<>();
        List<Producto> listaProductos= productoServicio.listarTodosProductos();
        for(int i=0; i<listaProductos.size(); i++){
            Producto producto= listaProductos.get(i);
            values.add(productoServicio.calificacionPromedio(producto.getCodigo()));
        }
        values.add(7);
    ...
    public void createBarModel2() {
        ...
        BarChartDataSet barDataSet = new BarChartDataSet();
        barDataSet.setLabel("Medio de Pago");
    ...
    public void createHorizontalBarModel() {
        ...
        hbarDataSet.setLabel("Medios de pago");

        List<Number> values = new ArrayList<>();

        List<String> listaMedios = new ArrayList<>();
        listaMedios.add("PSE");
        listaMedios.add("Efectivo");
        listaMedios.add("Transferencia");
        listaMedios.add("Tarjeta crédito");
        listaMedios.add("Paypal");

        for(int i=0; i<listaMedios.size(); i++){
            values.add(productoServicio.medioPago(listaMedios.get(i)));
        }
